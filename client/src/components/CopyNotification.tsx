...
const CopyNotification: React.FC<CopyNotificationProps> = ({ message, isVisible, onClose }) => {
  ...
  return (
    <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-1.5 bg-gray-800 dark:bg-gray-700 text-white text-sm rounded shadow-lg z-50 whitespace-nowrap animate-fade-in">
      {message}
