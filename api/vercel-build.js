  ...
  try {
    ...
    if (!pastesTableExists[0].exists) {
      ...
      try {
        ...
        console.error('Error checking/adding password column:', columnError);
      ...
      try {
        ...
        if (contentColumnInfo.length > 0 && contentColumnInfo[0].is_nullable === 'NO') {
          ...
          console.log('Content column is already nullable or does not exist.');
        }
      } catch (columnError) {
        console.error('Error checking/modifying content column:', columnError);
        // Continue execution despite this error
      }
    }
    ...
    try {
      ...
      console.error('Error checking/creating blocks table:', tableError);
      // Continue execution despite this error
    }
    ...
    try {
      ...
      console.error('Error checking/creating files table:', tableError);
      // Continue execution despite this error
    }
